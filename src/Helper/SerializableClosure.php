...
use Opsource\QueryAdapter\Exceptions\SecurityException;
use Serializable;
...
class SerializableClosure implements Serializable
{
     ...
     *
     * @see \Opsource\QueryAdapter\Helper\SerializableClosure::getClosure()
     */
    protected $closure;
     ...
     *
     * @see \Opsource\QueryAdapter\Helper\SerializableClosure::getReflector()
     */
    protected $reflector;
     ...
     *
     * @see \Opsource\QueryAdapter\Helper\SerializableClosure::unserialize()
     * @see \Opsource\QueryAdapter\Helper\SerializableClosure::getReflector()
     */
    protected $code;
    ...
    public const ARRAY_RECURSIVE_KEY = '';
